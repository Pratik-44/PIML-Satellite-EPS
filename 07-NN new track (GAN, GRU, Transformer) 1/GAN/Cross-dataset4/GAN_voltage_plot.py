...
gan_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GAN/Cross-dataset4/voltage_gan_predictions.csv")
...
plot_voltage_model(gan_df, "Voltage_GAN_vs_Original(trainset_synth.csv vs feb2026rb2r2_updated.txt)")