...
gan_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GAN/Cross-dataset/voltage_gan_predictions.csv")
...
plot_voltage_model(gan_df, "Voltage_GAN_vs_Original(orig_mod_timecorr vs samedata_r2_updated)")