...
gan_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GAN/Cross-dataset/power_gan_predictions.csv")
...
plot_power_model(gan_df, "Power_GAN_vs_Original(orig_mod_timecorr vs samedata_r2_updated)")