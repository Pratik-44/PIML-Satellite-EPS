...
gan_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GAN/Cross-dataset2/voltage_gan_predictions.csv")

print("GAN merged:", gan_df.shape)

# =========================
# 5. PLOT
# =========================

plot_voltage_model(gan_df, "Voltage_GAN_vs_Original(dec2025rb2r2_updated.txt vs feb2026rb2r2_updated.txt)")