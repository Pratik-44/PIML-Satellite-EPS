...
gan_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GAN/Cross-dataset2/power_gan_predictions.csv")
...
plot_power_model(gan_df, "Power_GAN_vs_Original(dec2025rb2r2_updated.txt vs feb2026rb2r2_updated.txt)")