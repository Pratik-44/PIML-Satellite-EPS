...
trans_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/Transformer/Cross-dataset3/voltage_transformer_predictions.csv")
...
plot_voltage_model(trans_df, "Voltage_Transformer_vs_Original(schedule_predictions.csv vs feb2026rb2r2_updated.txt)")