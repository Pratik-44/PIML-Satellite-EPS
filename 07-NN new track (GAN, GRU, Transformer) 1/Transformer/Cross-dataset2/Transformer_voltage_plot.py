...
trans_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/Transformer/Cross-dataset2/voltage_transformer_predictions.csv")
...
plot_voltage_model(trans_df, "Voltage_Transformer_vs_Original(dec2025rb2r2_updated.txt vs feb2026rb2r2_updated.txt)")