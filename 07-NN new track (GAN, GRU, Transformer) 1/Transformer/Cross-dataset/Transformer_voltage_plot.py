...
trans_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/Transformer/Cross-dataset/voltage_transformer_predictions.csv")
...
plot_voltage_model(trans_df, "Voltage_Transformer_vs_Original(orig_mod_timecorr vs samedata_r2_updated)")