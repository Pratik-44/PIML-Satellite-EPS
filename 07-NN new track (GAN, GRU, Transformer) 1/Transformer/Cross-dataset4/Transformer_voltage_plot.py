...
trans_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/Transformer/Cross-dataset4/voltage_transformer_predictions.csv")
...
plot_voltage_model(trans_df, "Voltage_Transformer_vs_Original(trainset_synth.csv vs feb2026rb2r2_updated.txt)")