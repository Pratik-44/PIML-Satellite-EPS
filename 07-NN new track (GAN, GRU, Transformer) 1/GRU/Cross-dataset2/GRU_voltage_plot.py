...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset2/voltage_GRU_predictions.csv")

print("GRU merged:", gru_df.shape)

# =========================
# 5. PLOT
# =========================

plot_voltage_model(gru_df, "Voltage_GRU_vs_Original(dec2025rb2r2_updated.txt vs feb2026rb2r2_updated.txt)")