...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset2/power_GRU_predictions.csv")
...
plot_power_model(gru_df, "Power_GRU_vs_Original(dec2025rb2r2_updated.txt vs feb2026rb2r2_updated.txt)")