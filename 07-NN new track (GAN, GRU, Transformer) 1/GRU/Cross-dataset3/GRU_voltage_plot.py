...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset3/voltage_GRU_predictions.csv")
...
plot_voltage_model(gru_df, "Voltage_GRU_vs_Original(schedule_predictions.csv vs feb2026rb2r2_updated.txt)")