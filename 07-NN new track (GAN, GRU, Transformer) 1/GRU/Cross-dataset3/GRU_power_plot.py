...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset3/power_GRU_predictions.csv")
...
plot_power_model(gru_df, "Power_GRU_vs_Original(schedule_predictions.csv vs feb2026rb2r2_updated.txt)")