...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset/power_GRU_predictions.csv")
...
plot_power_model(gru_df, "Power_GRU_vs_Original(orig_mod_timecorr vs samedata_r2_updated)")