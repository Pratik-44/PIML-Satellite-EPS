...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset/voltage_GRU_predictions.csv")
...
plot_voltage_model(gru_df, "Voltage_GRU_vs_Original(orig_mod_timecorr vs samedata_r2_updated)")