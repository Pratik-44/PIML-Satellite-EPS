...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset4/voltage_GRU_predictions.csv")
...
plot_voltage_model(gru_df, "Voltage_GRU_vs_Original(trainset_synth.csv vs feb2026rb2r2_updated.txt)")