...
gru_df = load_and_merge("F:/Downloads/PIML_Results/NN new track/GRU/Cross-dataset4/power_GRU_predictions.csv")
...
plot_power_model(gru_df, "Power_GRU_vs_Original(trainset_synth.csv vs feb2026rb2r2_updated.txt)")