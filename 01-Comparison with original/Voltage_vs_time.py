...
plt.plot(orig_p["timestamp"], orig_p["voltage"], label="Original")
plt.plot(piml_p["timestamp"], piml_p["voltage"], label="PIML")

plt.xlabel("Time")
plt.ylabel("Voltage (V)")
plt.title("Voltage vs Time: Original vs PIML")
plt.legend()
plt.grid(True)

plt.tight_layout()
plt.savefig("voltage_original_vs_piml.png", dpi=300)
plt.show()
...
plt.figure(figsize=(14,5))
plt.plot(orig_m["timestamp"], orig_m["voltage"], label="Original")
plt.plot(ml_m["timestamp"],   ml_m["voltage"], label="ML")

plt.xlabel("Time")
plt.ylabel("Voltage (V)")
plt.title("Voltage vs Time: Original vs ML")
plt.legend()
plt.grid(True)

plt.tight_layout()
plt.savefig("voltage_original_vs_ml.png", dpi=300)
plt.show()
