...
plt.plot(orig_p["timestamp"], orig_p["current"], label="Original")
plt.plot(piml_p["timestamp"], piml_p["current"], label="PIML")

plt.xlabel("Time")
plt.ylabel("Current (A)")
plt.title("Current vs Time: Original vs PIML")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("current_original_vs_piml.png", dpi=300)
plt.show()


# ---- ORIGINAL vs ML (Current)
...
plt.figure(figsize=(14,5))
plt.plot(orig_m["timestamp"], orig_m["current"], label="Original")
plt.plot(ml_m["timestamp"],   ml_m["current"], label="ML")

plt.xlabel("Time")
plt.ylabel("Current (A)")
plt.title("Current vs Time: Original vs ML")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("current_original_vs_ml.png", dpi=300)
plt.show()
