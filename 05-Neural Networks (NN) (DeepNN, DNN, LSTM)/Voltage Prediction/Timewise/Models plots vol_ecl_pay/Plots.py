...
dnn_df = load_and_merge("F:/Downloads/PIML_Results/NN/Voltage Prediction/60-40/voltage_DNN_predictions.csv")
deepnn_df = load_and_merge("F:/Downloads/PIML_Results/NN/Voltage Prediction/60-40/voltage_DeepNN_predictions.csv")
lstm_df = load_and_merge("F:/Downloads/PIML_Results/NN/Voltage Prediction/60-40/voltage_LSTM_predictions.csv")
...
plot_voltage_model(dnn_df, "Voltage_DNN_vs_Original_inverse_ecl_flag")
plot_voltage_model(deepnn_df, "Voltage_DeepNN_vs_Original_inverse_ecl_flag")
plot_voltage_model(lstm_df, "Voltage_LSTM_vs_Original_inverse_ecl_flag")
