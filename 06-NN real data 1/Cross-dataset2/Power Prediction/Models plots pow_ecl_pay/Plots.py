...
dnn_df = load_and_merge("F:/Downloads/PIML_Results/NN real data/Cross-dataset2/Power Prediction/power_DNN_predictions.csv")
deepnn_df = load_and_merge("F:/Downloads/PIML_Results/NN real data/Cross-dataset2/Power Prediction/power_DeepNN_predictions.csv")
lstm_df = load_and_merge("F:/Downloads/PIML_Results/NN real data/Cross-dataset2/Power Prediction/power_LSTM_predictions.csv")
...
plot_power_model(dnn_df, "Power_DNN_vs_Original")
plot_power_model(deepnn_df, "Power_DeepNN_vs_Original")
plot_power_model(lstm_df, "Power_LSTM_vs_Original")