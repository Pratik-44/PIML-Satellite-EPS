...
file_path = "F:/Downloads/PIML_Results/NN real data/predicted_telemetry (1).csv"
...
def plot_original_power(df, title):
...
plot_original_power(df, "predicted_telemetry_Original_Power_Profile")