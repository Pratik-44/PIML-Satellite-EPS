...
dnn_df = load_and_merge("F:/Downloads/PIML_Results/NN real data/Cross-dataset3/Voltage Prediction/voltage_DNN_predictions.csv")
deepnn_df = load_and_merge("F:/Downloads/PIML_Results/NN real data/Cross-dataset3/Voltage Prediction/voltage_DeepNN_predictions.csv")
lstm_df = load_and_merge("F:/Downloads/PIML_Results/NN real data/Cross-dataset3/Voltage Prediction/voltage_LSTM_predictions.csv")
